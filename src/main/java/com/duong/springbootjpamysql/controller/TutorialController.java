package com.duong.springbootjpamysql.controller;

import com.duong.springbootjpamysql.model.Tutorial;
import com.duong.springbootjpamysql.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public ResponseEntity<Map<String, Object>> getAllTutorialsPage(
        ...
        try {
            ...
            if (sort[0].contains(",")) {
                //will sort more than two fields
